					...
					<form action="outku/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="GOODS_NAME" id="GOODS_NAME" value="${pd.GOODS_NAME}" maxlength="32" placeholder="这里不需要手动输入" title="商品名称" style="width:99%;" readonly="readonly"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="CUSTOMER_NAME" id="CUSTOMER_NAME" value="${pd.CUSTOMER_NAME}" maxlength="32" placeholder="这里输入客户" title="客户" readonly="readonly" style="width:89%;"/>

...
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<c:if test="${QX.cha == 1}">
			<div>
				<iframe name="treeFrame" id="treeFrame" frameborder="0" src="<%=basePath%>/outku/dingdanList.do" style="margin:0 auto;width:100%;height:600px;"></iframe>
			</div>
		</c:if>
